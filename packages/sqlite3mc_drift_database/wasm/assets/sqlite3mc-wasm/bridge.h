...
import_dart("fs_sync") extern int   dartSync(const char *zPath, int flags);
import_dart("fs_lock") extern int  dartLock(const char * zPath,int flags) ;
import_dart("fs_unlock") extern int dartUnlock(const char * zPath,int flags);
